...
#processes the json received by nasa
#previous issue with string representation of floats stored in json, which made comparison with numerical inputs difficult
#convert all floats in string format to floats. 
def process():
